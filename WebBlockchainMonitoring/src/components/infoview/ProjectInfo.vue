<template>
    <div class=" mt-4 px-4">
        <div class="d-flex">
            ...
            <div class="ms-auto">
                    <a href="https://idmc.univ-lorraine.fr/" target="_blank">
                        <img class="logo" src="@/assets/idmc.png" alt="IDMC">
                    </a>
            </div>
        </div>
        <div>
            ...
            <p class="text">This web interface is meant to be locally connected to an API that you can find <a href="https://github.com/MoissBatt/BlockchainMIAGE/blob/master/README.md" target="_blank">
                    ...
                    and the costs of the transactions for every blocks. It is also possible to check the average mining time for example.
            </p>
        </div>
